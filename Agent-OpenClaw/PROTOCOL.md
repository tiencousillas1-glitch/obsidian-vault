# Protocolo Obsidian — Clowy (OpenClaw)

## Ubicación del Vault
`/home/tien/Obsidian Vault/`

## Tu carpeta
`/home/tien/Obsidian Vault/Agent-OpenClaw/`
...
4. Leé `Agent-OpenClaw/working-context.md` (tu estado anterior)
...
- Escribí resumen en `Agent-OpenClaw/daily/YYYY-MM-DD.md`
